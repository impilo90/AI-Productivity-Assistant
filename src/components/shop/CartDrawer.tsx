...
export function CartDrawer() {
  ...
  const currencyCode = items[0]?.price.currencyCode ?? "ZAR";
      ...
      <SheetTrigger asChild>
        ...
        >
          ...
          {mounted && totalItems > 0 && (
            <Badge className="absolute -top-1.5 -right-1.5 h-5 w-5 rounded-full p-0 flex items-center justify-center text-xs bg-primary text-primary-foreground border-0">
              {totalItems}
            </Badge>
          )}
        </Button>
